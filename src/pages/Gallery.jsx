...
const GameGallery = () => {
    ...
    const gameData = [
      {
        ...
        genre: "Racing",
        description: "Compete with rivals, challenge your friends, and place on-chain bets to elevate the fun.",
  ...
  return (
    <Box sx={{ backgroundColor: "#060824",  width: "100%", height: "90vh", overflowY: "auto",
        scrollbarWidth: "none",
        "&::-webkit-scrollbar": {
            display: "none",
        }, py: 4 }}>
      <Container maxWidth="lg">
              ...
              <Stack spacing={2}>
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    ...
                    <Typography variant="subtitle1" sx={{ color: "#ffffff80" }}>
        ...
        <Stack spacing={2} sx={{ mt: 4 }}>
          {games.map((game, index) => (
            ...
            >
              <SquareGameCard sx={{ width: "100px", height: "100px" }}>
                <CardMedia
                  component="img"
              ...
              <Box sx={{ flex: 1 }}>
                ...
                <Typography variant="body2" sx={{ color: "#ffffff80", mt: 0.5 }}>
                  {game.description}
                </Typography>
              </Box>
              <Chip
