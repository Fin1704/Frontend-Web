...
import { FaWindows, FaApple, FaAndroid, FaSteam, FaTwitter, FaFacebook, FaShare } from "react-icons/fa";
...
function AlphaltThunder ()  {
  ...
  const gameData = {
    ...
    description: "Embark on an epic journey in this open-world RPG where your choices shape the future of a dystopian metropolis. Featuring cutting-edge graphics and an immersive storyline that adapts to your decisions.",
    genre: "Action RPG",
      ...
      <Grid container spacing={4}>
        <Grid item xs={12} md={8}>
          ...
          <Box sx={{ display: "flex", gap: 1, mb: 2 }}>
            {gameData.platforms.includes("Windows") && <FaWindows size={24} />}
            {gameData.platforms.includes("MacOS") && <FaApple size={24} />}
            {gameData.platforms.includes("Android") && <FaAndroid size={24} />}
          </Box>
                ...
                <StyledPaper>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12} sm={6}>
                      ...
                      <Chip label={gameData.genre} icon={<IoGameController />} />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <Typography variant="subtitle1" fontWeight="bold">
                        Release Date:
