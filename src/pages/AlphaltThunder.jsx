                ...
                <Grid container spacing={4}>
                    ...
                    <Grid item xs={12} md={8}>
                        <Box sx={{ position: "relative" }}>
                            ...
                            >
                                {gameData.screenshots[activeStep].endsWith(".mp4") ? (
                                    <video
                                        src={gameData.screenshots[activeStep]}
                                        style={{
                                            width: "100%",
                            ...
                            <Box sx={{ display: "flex", gap: 1, mt: 1 }}>
                                {gameData.screenshots.map((screenshot, index) => (
                                    <Box
                                        key={index}
                                        component="img"
                                        src={screenshot.endsWith(".mp4") ? "/assets/logogame.png" : screenshot}
                                        sx={{
                                            width: 80,
                                            height: 45,
                                            objectFit: "cover",
                    ...
                    <Grid item xs={12} md={4}>
                        <Paper sx={{ p: 2, backgroundColor: "#0a0e35", color: "#e0e0e0" }}>
                            ...
                            <Box sx={{ display: "flex", gap: 1, mb: 2 }}>
                                ...
                                <IconButton sx={{ color: "#3f51b5" }} onClick={handleShare}>
                                    <FaShare />
                                </IconButton>
                            </Box>
                            ...
                            <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap" }}>
                                ...
                                <Box sx={{ mb: 3 }}>
                                    ...
                                    <Chip
                                        label="Multiplayer"
                                        sx={{ mr: 1, background: "#2b78d4", color: "white" }}
                                    />
                                    <Chip
                                        label="Racing"
                                        sx={{ background: "#2b78d4", color: "white" }}
                                    />
                                </Box>
                            </Box>
                        </Paper>
